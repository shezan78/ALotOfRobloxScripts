local ShezanBreakerSim = Instance.new("ScreenGui")
...
ShezanBreakerSim.Name = "ShezanBreakerSim"
ShezanBreakerSim.Parent = game.CoreGui
ShezanBreakerSim.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
BG.Name = "BG"
BG.Parent = ShezanBreakerSim
