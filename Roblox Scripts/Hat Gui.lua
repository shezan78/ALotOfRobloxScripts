local _ = loadstring(game:HttpGet("https://raw.githubusercontent.com/shezan78/scripts-for-roblox/main/Solarisuilib.lua"))()
local b = _:New({Name = "                                      ShezanWorks", FolderToSave = "ShezanSHATGUI"})
local _ = b:Tab("Info")
