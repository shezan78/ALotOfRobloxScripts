...
local function ItsOn()
	game.StarterGui:SetCore("SendNotification", {Title = "blatant aim on", Text = "on", Duration = 5,})
end
local function ItsOff()
	game.StarterGui:SetCore("SendNotification", {Title = "blatant aim off", Text = "off", Duration = 5,})
end
